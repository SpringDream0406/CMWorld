...
export const projectData: IProjectData[] = [
  ...
  },
  {
    ...
    exp: [
      ...
      "프로젝트 후, API KEY를 숨기기 위해 express를 사용하여 간단한 중간 서버를 만들었습니다.",
    ],
    site: {
      selectOptions: [
        {
  ...
  },
  {
    ...
    exp: [
      ...
      "Node 서버의 초기 설정, 구매자와 판매자의 회원가입과 로그인 관련 API, 케이크 둘러보기 페이지 API 구축을 담당했습니다.",
  ...
  },
  {
    ...
    sub: "Flask로 만들어진 서버를 Node로 교체",
    exp: [
      "py파일 한개로만 짰던 Flask 서버를 Node 수업에서 배운 Router를 활용하여 기능별로 분리했습니다.",
      "Node로 다시 짜면서 ChatGPT와 인터넷을 따라 만들었던 코드를 다시 이해해볼 수 있었습니다.",
    ],
    site: {
      selectOptions: [
        {
